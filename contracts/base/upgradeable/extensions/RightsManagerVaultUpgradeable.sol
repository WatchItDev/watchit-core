...
/// @title Rights Manager Vault Upgradeable
...
abstract contract RightsManagerVaultUpgradeable is Initializable, IContentVault {
    /// @custom:storage-location erc7201:rightsmanagervaultupgradeable.encrypted
    struct VaultStorage {
        mapping(uint256 => bytes) _encrypted; // Mapping to store encrypted content by content ID
    }
    ...
    function _secureContent(
        ...
        VaultStorage storage $ = _getVaultStorage();
        $._encrypted[contentId] = encrypted;
    }
}
