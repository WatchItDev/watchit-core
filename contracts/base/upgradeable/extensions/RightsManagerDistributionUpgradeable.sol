...
abstract contract RightsManagerDistributionUpgradeable is Initializable, IRightsCustodial {
    ...
    function hasCustodial(address distributor, uint256 contentId) public view returns(bool) {
         DistributionRightsStorage storage $ = _getRightsStorage();
